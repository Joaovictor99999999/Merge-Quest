...
var indice_frase_progresso: int = 0
...
func iniciar_cutscene_progresso():
	...
	dialogo.connect("dialogo_finalizado", executar_sequencia_de_paginas, CONNECT_ONE_SHOT)
	...
	var frase_escolhida = frases[indice_frase_progresso % frases.size()]
	indice_frase_progresso += 1
