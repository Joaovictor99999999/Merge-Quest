...
func _ready():
	# Forçamos o pause
	var font = preload("res://outros/ithaca-font/Ithaca-LVB75.ttf")  # ou .fontdata
	font.get_string_size("áéíóúâêîôûãõçÁÉÍÓÚÂÊÎÔÛÃÕÇàèìòùÀÈÌÒÙ")
...
func exibir_dialogo_inicio_de_jogo():
	...
	dialogo.iniciar_dialogo(
		[
		"Para voce que chegou agora, nao se assute.",
